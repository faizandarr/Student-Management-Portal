...
{
    public partial class Allocate_Faculty_Courses : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string sql = "insert into faculty_course values('" + sid + "'," + cid + ")";

            string count = "select count(course_id) from faculty_course where student_id = '" + sid + "' group by student_id having count(course_id) <4";
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            string sql = "update faculty_course set course_id = " + cidu + "where student_id = '" + sid + "' and course_id = " + cid;
            SqlCommand cm;
            cm = new SqlCommand(sql, conn);
            cm.ExecuteNonQuery();
